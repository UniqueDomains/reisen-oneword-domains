...
> **Important:** this repository is a **public 9,776-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,957 domains** on the canonical page below.

**Public extract:** 9,776 rows · **Live catalog:** 5,621,957 domains
...
| ----------------------- | ------------------------------------------------ |
| 9,776-row public sample | 5,621,957 live domains                           |
...
> Unique Domains. *Available .REISEN One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
