# Available .REISEN One-Word Domains (5,621,957)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C775%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C621%2C957%20domains-6f42c1">
...
> **Important:** this repository is a **public 9,775-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,957 domains** on the canonical page below.

**Public extract:** 9,775 rows · **Live catalog:** 5,621,957 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/reisen?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_reisen_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/reisen?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_reisen_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./reisen.csv">CSV</a> / <a href="./reisen.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_reisen_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_reisen_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .REISEN search](https://unique.domains/domains/tld/reisen?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_reisen_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .REISEN search](https://unique.domains/domains/tld/reisen?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_reisen_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./reisen.csv) or [Download JSON](./reisen.json)
...
- `reisen.csv` — public CSV extract (9,775 rows)
- `reisen.json` — public JSON extract (9,775 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,775-row public sample | 5,621,957 live domains                           |
...
| data.reisen     | available | $28.98    | —             | 70             | 60     | 4      | namecheap                                   |
...
| weed.reisen     | resell    | —         | —             | 58             | 40     | 4      | IONOS SE                                    |
...
| clear.reisen    | available | $24.99    | $26.99        | 90             | 50     | 5      | name.com                                    |
...
> Unique Domains. *Available .REISEN One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
